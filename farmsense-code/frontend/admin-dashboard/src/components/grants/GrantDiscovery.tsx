...
const SEED_OPPORTUNITIES: Opportunity[] = [
    { id: 'ESTCP-FY26-IR', sourceId: 'estcp', title: 'Water Resilience on DoD Installations', funderName: 'DoD ESTCP', program: 'Installation Resilience', deadline: '2026-03-26', awardMin: 1500000, awardMax: 3000000, relevance: 97, tags: ['groundwater', 'resilience', 'sensing', 'aquifer'], description: 'Certifies technologies that reduce DoD installation dependence on stressed groundwater basins through real-time monitoring and AI-driven demand forecasting.', url: 'https://www.serdp-estcp.mil', saved: true },
