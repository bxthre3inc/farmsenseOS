      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-24">
          ...
          <div className="flex items-start gap-6 mb-8">
            ...
            <div>
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-3">Android-Native Agent-First IDE</h1>
              <p className="text-xl text-zinc-400">Mobile-Native Development Environment</p>
            </div>
          </div>
