# Technical Seed Dossier: FarmSense SLV Deployment

**Prepared by:** Jeremy Beebe | Bxthre3 Inc.  
**Funding Ask:** $25,000.00 | **Equity:** 1% SAFE (FarmSense, Inc.)

---

## Executive Summary

The FarmSense hardware and software architectures are the result of extensive, rigorous engineering culminating in a complete 400-page proprietary Master Blueprint. The purpose of this document is to provide complete, transparent visibility into the $25,000.00 seed runway required to translate this verified engineering into the Stage 1 physical pilot at the Colorado State University (CSU) San Luis Valley Research Center in Center, CO.

This runway covers three strictly budgeted pillars:

1. **The Physical Hardware (CapEx):** Procurement of sensors, 900MHz radios, and solar systems to construct two autonomous center pivots and one District Hub.
...
The explicit strategy of offering 1% equity for the initial $25k Seed round (via a Y-Combinator SAFE) mathematically anchors the company at a $2.5M valuation. Because FarmSense integrates DoD-grade communications and spatial encryption, it must secure multi-million dollar Phase 2 Federal & VC grants next year to scale properly. Grant boards automatically disqualify startups where the founder has surrendered excessive early equity (e.g., >10-15%).
...
## Pillar 1: Pilot Hardware Operations (CapEx)

*Summing the exhaustive list of individual components, parts, tools, and wire down to the single-unit retail price levels required to fabricate the systems in the Monte Vista workshop.*
...
| **Cloud Proxy Server** | $2,350.00 | Dedicated local Mini-PC server and reliable mid-level developer workstation to act as the Regional Superstation (RSS) compiling the C++ firmware locally. |
| **Total CapEx Required** | **$5,631.00** | *Fully funds the physical construction of the pilot array.* |

---

## Pillar 2: 6-Month Pilot Deployment (OpEx)

*Hardware alone does not run a pilot. This segment funds the active deployment, streaming, data hosting, and founder survival from May through October.*

| Operations Category | Cost Allocated | Justification |
| :--- | :--- | :--- |
| **RTK GNSS Subscriptions** | $1,200.00 | Cellular Ntrip access for 2 PMT rovers to pull centimeter-level pivot tracking via the Colorado CORS network. |
...
## Pillar 3: Corporate Shielding & Patent Security

*If the pilot succeeds, the IP must be legally secured before CSU or agricultural partners are given access to the core engine. This establishes the corporate framework and the defensive Picket Fence patents.*

| Legal & Corporate Action | Cost Allocated | Justification |
| :--- | :--- | :--- |
...
### **Total Phase 1 Seed Target: $25,000.00**
