# LRZ Firmware Specification — MERGED

> **MERGED (2026-03-05):** This file's content has been consolidated into the canonical LRZ Master Specification:
>
> [`docs/specifications/Master Specification: Lateral Root-Zone Scout (LRZ) V1.21.md`](../../../../specifications/Master%20Specification:%20Lateral%20Root-Zone%20Scout%20%28LRZ%29%20V1.21.md) — see **§6 Firmware Details (v2.4.1)**
>
