...
* **Enterprise Tier (1m Resolution)**: The ultimate "Gold Truth." Requires the full deployment of the physical hardware mesh (2:4:12 ratio). Features **sub-meter grid accuracy** with a 1cm **"Precision Query"** capability and real-time VRI actuation. Costs $30/acre.
...
* **Lateral Root-Zone Scout (LRZ) [The Spatial Scout]:** **$54.30** / unit (Deployed in 2:4:12 ratio per field).
  ...
  * *Key Cost Drivers*: "Fringe Field" Probes, Refurbishable Sensing Spine.
* **Pivot Motion Tracker (PMT) [The Field Conductor]:** **$1,035.50** / unit
  * *Core Silicon*: ESP32-S3 (Vector Accel) + u-blox ZED-F9P (RTK GNSS).
  * *Key Cost Drivers*: Badger Meter Ultrasonic Flow Pair ($548), ZED-F9P ($140).
...
* **Regional Superstation (RSS):** **$212,000.00**. The Territory Cortex. Features 64-Core AMD Threadripper PRO, dual RTX A6000 GPUs, and 50TB NVMe storage. Serves as the localized Oracle for generating Kriging maps and storing the Digital Ledger.
* **Aerial Fleet Mobilization:** $24,500 initial CapEx (eBee Ag + DJI Mavic M3M).
